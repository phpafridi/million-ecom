...
class SettingController extends Controller
{
    ...
    public function update(Request $request)
    {
        $data = $request->validate([
            ...
            'home_show_categories'    => 'nullable|string|max:5',
            'home_categories_title'   => 'nullable|string|max:100',
            'home_show_accessories'   => 'nullable|string|max:5',
            'home_accessories_category' => 'nullable|string|max:100',
            'home_accessories_title'  => 'nullable|string|max:100',
            'home_show_new_in'        => 'nullable|string|max:5',
            'home_new_in_title'       => 'nullable|string|max:100',
            'home_show_sale'          => 'nullable|string|max:5',
            'home_sale_title'         => 'nullable|string|max:100',
            // Cart & Chat
        ...
        $keys = [
            ...
            'home_show_categories', 'home_categories_title',
            'home_show_accessories', 'home_accessories_category', 'home_accessories_title',
            'home_show_new_in', 'home_new_in_title',
            'home_show_sale', 'home_sale_title',
