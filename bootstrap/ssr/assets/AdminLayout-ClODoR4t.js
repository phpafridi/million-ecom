  ...
  const Sidebar = () => {
    ...
    return /* @__PURE__ */ jsxs("div", { className: "flex flex-col h-full", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2.5 px-4 h-16 border-b border-white/8 flex-shrink-0", children: [
        ((_a2 = props.settings) == null ? void 0 : _a2.logo_url) ? (
          // Real logo already carries the brand — show it alone, no
          // competing text squeezed in next to it.
          /* @__PURE__ */ jsx("div", { className: "h-9 flex-1 min-w-0 flex items-center overflow-hidden", children: /* @__PURE__ */ jsx("img", { src: props.settings.logo_url, alt: siteName, className: "h-full w-auto object-contain", style: { maxHeight: 36, maxWidth: "100%" } }) })
