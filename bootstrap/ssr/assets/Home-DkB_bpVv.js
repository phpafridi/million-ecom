...
function Home({ heroSlides, featuredProducts, onSaleProducts, topRatedProducts, newProducts, categories, topCategories, categoryProducts, banners, settings, auth }) {
  ...
  return /* @__PURE__ */ jsxs(StorefrontLayout, { auth, settings, children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "px-4 sm:px-6 lg:px-10 my-6 sm:my-8", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4 sm:gap-6 max-w-[1400px] mx-auto", children: [
      ...
      /* @__PURE__ */ jsxs(
        "div",
        {
          className: "flex items-center gap-2 flex-shrink-0 px-4 py-2 rounded-full border",
          style: { borderColor: "var(--color-primary, #C9A84C)", background: "rgba(201,168,76,0.08)" },
          children: [
            /* @__PURE__ */ jsx("span", { className: "text-[13px] sm:text-[15px]", children: "✨" }),
            /* @__PURE__ */ jsxs("span", { className: "font-manrope font-black text-[10px] sm:text-[11.5px] uppercase tracking-[0.15em]", style: { color: "var(--color-dark-bg, #0a0a0a)" }, children: [
              "Fresh Drops ",
              /* @__PURE__ */ jsx("span", { style: { color: "var(--color-primary, #C9A84C)" }, children: "Meet" }),
              " Fan Favorites"
            ] }),
            /* @__PURE__ */ jsx("span", { className: "text-[13px] sm:text-[15px]", children: "✨" })
          ]
