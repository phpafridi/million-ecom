...
import { IconShoppingCart, IconBuildingBank, IconUpload, IconX, IconCheck, IconBrandWhatsapp, IconArrowLeft, IconAlertCircle, IconMinus, IconPlus, IconTrash, IconTruck } from "@tabler/icons-react";
...
function Cart({ items, subtotal, shipping, total, discount = 0, points_discount = 0, coupon_discount = 0, loyalty_points = 0, loyalty_value = 0, points_used = 0, loyalty_enabled = true, redeem_enabled = true, user_profile, gateways, settings, auth }) {
  var _a, _b, _c;
  ...
  const { data, setData, post, processing, errors, setError, clearErrors } = useForm({
    name: (user_profile == null ? void 0 : user_profile.name) ?? ((_a = auth == null ? void 0 : auth.user) == null ? void 0 : _a.name) ?? "",
    phone: (user_profile == null ? void 0 : user_profile.phone) ?? "",
    email: (user_profile == null ? void 0 : user_profile.email) ?? ((_b = auth == null ? void 0 : auth.user) == null ? void 0 : _b.email) ?? "",
    address: (user_profile == null ? void 0 : user_profile.address) ?? "",
    city: (user_profile == null ? void 0 : user_profile.city) ?? "",
    gateway: ((_c = gateways[0]) == null ? void 0 : _c.code) ?? "cod",
    notes: ""
  });
    ...
    /* @__PURE__ */ jsxs("div", { className: "max-w-6xl mx-auto px-4 sm:px-6 py-6 sm:py-8", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-3 gap-6", children: [
        ...
        /* @__PURE__ */ jsx("div", { children: /* @__PURE__ */ jsxs("div", { className: "bg-white rounded-2xl border border-gray-100 p-5 sticky top-[130px]", children: [
          ...
          step === "cart" && /* @__PURE__ */ jsx("div", { className: "mt-4 pt-4 border-t border-gray-100", children: /* @__PURE__ */ jsxs("form", { onSubmit: applyCoupon, className: "flex gap-2", children: [
            /* @__PURE__ */ jsx(
              "input",
              {
                value: couponCode,
