...
import { P as ProductCard } from "./ProductCard-CsBPEw1s.js";
      ...
      "div",
      {
        ...
        children: /* @__PURE__ */ jsx(
          "div",
          {
            ...
            children: items.map((p, i) => /* @__PURE__ */ jsx(
              "div",
              {
                style: {
...
function Home({ heroSlides, featuredProducts, onSaleProducts, topRatedProducts, newProducts, categories, topCategories, categoryProducts, banners, settings, auth }) {
  ...
  return /* @__PURE__ */ jsxs(StorefrontLayout, { auth, settings, children: [
    ...
    /* @__PURE__ */ jsxs("section", { className: "py-5 sm:py-6", children: [
          ...
          "div",
          {
            ...
            children: !loaded ? Array(8).fill(0).map((_, i) => /* @__PURE__ */ jsx(
              "div",
              {
                ...
                children: /* @__PURE__ */ jsx("div", { className: "bg-gray-200 rounded-[18px] w-full", style: { aspectRatio: "3/4" } })
              },
              i
              ...
              Link_default,
              {
                ...
                style: { width: "calc(50% - 6px)", scrollSnapAlign: "start" },
                children: /* @__PURE__ */ jsxs("div", { className: "relative overflow-hidden rounded-[18px] w-full", style: { aspectRatio: "3/4" }, children: [
                  /* @__PURE__ */ jsx(
                    "img",
                    {
      ...
      /* @__PURE__ */ jsx("div", { className: "hidden lg:grid lg:grid-cols-8 gap-3 px-10", children: !loaded ? Array(8).fill(0).map((_, i) => /* @__PURE__ */ jsx(CategorySkeleton, {}, i)) : categories.slice(0, 8).map((cat, i) => /* @__PURE__ */ jsx(motion.div, { initial: { opacity: 0, scale: 0.95 }, animate: { opacity: 1, scale: 1 }, transition: { delay: i * 0.04 }, children: /* @__PURE__ */ jsxs(
        Link_default,
        {
          href: `/shop?category=${cat.slug}`,
          ...
          children: [
            /* @__PURE__ */ jsx("img", { src: cat.image ?? "/images/placeholder.jpg", alt: cat.name, className: "w-full aspect-square object-cover block", loading: "lazy" }),
            /* @__PURE__ */ jsx("span", { className: "block text-[11px] font-bold text-gray-900 py-2 px-1 truncate", children: cat.name })
          ]
        }
      ) }, cat.id)) })
    ] }),
    b("full_hero") && /* @__PURE__ */ jsx(
      motion.section,
      {
          ...
          Link_default,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "absolute inset-0 flex flex-col items-center justify-center text-center px-4", children: [
                b("full_hero").subtitle && /* @__PURE__ */ jsx("span", { className: "text-[11px] sm:text-[12px] font-bold text-white/70 uppercase tracking-[.2em] mb-2", children: b("full_hero").subtitle }),
                /* @__PURE__ */ jsx(
                  "h2",
                  {
                    className: "font-manrope font-black text-white leading-[1.05] tracking-tight mb-1",
                    style: { fontSize: "clamp(22px, 4.5vw, 40px)" },
                    children: b("full_hero").title
                  }
                ),
                b("full_hero").cta_text && /* @__PURE__ */ jsx(
                  "span",
                  {
                    className: "mt-4 inline-flex items-center bg-white text-[var(--color-dark-bg, #0a0e1a)] font-black rounded-full",
                    style: { fontSize: "clamp(11px, 1.4vw, 13px)", padding: "clamp(8px, 1.2vw, 12px) clamp(18px, 2.4vw, 28px)" },
                    children: b("full_hero").cta_text
                  }
                )
              ] })
            ]
    ...
    /* @__PURE__ */ jsxs(
      motion.section,
      {
        ...
        transition: { duration: 0.55, ease: [0.22, 1, 0.36, 1] },
        children: [
          /* @__PURE__ */ jsxs("div", { className: "hidden lg:grid gap-3", style: { gridTemplateColumns: "340px 1fr", gridTemplateRows: "220px 228px" }, children: [
            (() => {
              ...
              Link_default,
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxs("div", { style: { position: "absolute", bottom: 14, left: 14, right: 14, zIndex: 10 }, children: [
                    b(pos).subtitle && /* @__PURE__ */ jsx("div", { style: { fontSize: 9.5, color: "var(--color-primary, #00c8ff)", fontWeight: 700, textTransform: "uppercase", letterSpacing: ".1em", marginBottom: 4 }, children: b(pos).subtitle }),
            ...
            /* @__PURE__ */ jsx("div", { style: { gridColumn: 2, gridRow: 2, position: "relative", borderRadius: 15, overflow: "hidden", cursor: "pointer", background: "#0a0e1a" }, className: "group", children: b("wide_bottom") ? /* @__PURE__ */ jsxs(Fragment, { children: [
              ...
              /* @__PURE__ */ jsxs("div", { style: { position: "absolute", top: "50%", transform: "translateY(-50%)", left: 20, zIndex: 10, maxWidth: 300 }, children: [
                b("wide_bottom").subtitle && /* @__PURE__ */ jsx("div", { style: { fontSize: 9.5, color: "var(--color-primary, #00c8ff)", fontWeight: 700, textTransform: "uppercase", letterSpacing: ".1em", marginBottom: 8 }, children: b("wide_bottom").subtitle }),
                ...
                /* @__PURE__ */ jsx(Link_default, { href: b("wide_bottom").link ?? "/shop", style: { display: "inline-flex", alignItems: "center", gap: 6, background: "var(--color-primary, #00c8ff)", color: "var(--color-dark-bg, #0a0e1a)", fontSize: 12, fontWeight: 800, padding: "8px 16px", borderRadius: 100, textDecoration: "none" }, children: b("wide_bottom").cta_text })
              ] })
            ] }) : /* @__PURE__ */ jsx("div", { className: "w-full h-full bg-gray-200 animate-pulse" }) })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "lg:hidden space-y-3", children: [
            (() => {
              const promo = b("promo") ?? b("featured") ?? (Object.keys(banners).length > 0 ? banners[Object.keys(banners)[0]] : null);
              return promo ? /* @__PURE__ */ jsxs(Link_default, { href: promo.link ?? "/shop", className: "relative rounded-[16px] overflow-hidden block no-underline", style: { height: 200, background: "var(--color-dark-bg,#0a0e1a)" }, children: [
                promo.video ? /* @__PURE__ */ jsx("video", { autoPlay: true, muted: true, loop: true, playsInline: true, className: "absolute inset-0 w-full h-full object-cover", children: /* @__PURE__ */ jsx("source", { src: promo.video, type: "video/mp4" }) }) : promo.image ? /* @__PURE__ */ jsx("img", { src: promo.image, alt: promo.title ?? "", className: "absolute inset-0 w-full h-full object-cover" }) : null,
                /* @__PURE__ */ jsx("div", { className: "absolute inset-0", style: { background: "linear-gradient(to top, rgba(0,0,0,0.9), transparent)" } }),
                /* @__PURE__ */ jsxs("div", { className: "absolute bottom-0 left-0 right-0 p-4 z-10", children: [
                  promo.subtitle && /* @__PURE__ */ jsx("div", { className: "text-[10px] font-bold uppercase tracking-wider mb-1", style: { color: "var(--color-primary)" }, children: promo.subtitle }),
                  /* @__PURE__ */ jsx("div", { className: "font-manrope font-black text-[16px] text-white mb-2", children: promo.title }),
                  promo.cta_text && /* @__PURE__ */ jsx("span", { className: "inline-flex items-center gap-2 text-[12px] font-black py-2 px-4 rounded-full", style: { background: "var(--color-primary)", color: "var(--color-primary-text,#0a0a0a)" }, children: promo.cta_text })
                ] })
              ] }) : null;
            })(),
            /* @__PURE__ */ jsx("div", { className: "grid grid-cols-2 gap-3", children: ["small_top_1", "small_top_2"].map((pos) => b(pos) && /* @__PURE__ */ jsxs(Link_default, { href: b(pos).link ?? "/shop", className: "relative rounded-[14px] overflow-hidden block no-underline group", style: { height: 140 }, children: [
              /* @__PURE__ */ jsx("img", { src: b(pos).image ?? "/images/placeholder.jpg", alt: b(pos).title, className: "absolute inset-0 w-full h-full object-cover transition-transform duration-500 group-hover:scale-[1.04]" }),
              /* @__PURE__ */ jsx("div", { className: "absolute inset-0", style: { background: "linear-gradient(to bottom, transparent, rgba(7,11,20,0.82))" } }),
              /* @__PURE__ */ jsxs("div", { className: "absolute bottom-3 left-3 right-3 z-10", children: [
                /* @__PURE__ */ jsx("div", { className: "font-manrope font-black text-[13px] text-white leading-[1.2] mb-1.5", children: b(pos).title }),
                /* @__PURE__ */ jsx("span", { className: "bg-white text-[var(--color-dark-bg, #0a0e1a)] text-[10px] font-black px-2.5 py-1 rounded-full", children: b(pos).cta_text })
              ] })
            ] }, pos)) })
          ] })
        ]
