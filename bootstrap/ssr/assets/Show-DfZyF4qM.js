...
function ProductShow({ product, related, wishlisted: initWishlisted, settings, auth }) {
  ...
  const missingRequired = hasVariants ? (product.variant_attributes ?? []).filter(
    (a) => {
      var _a2;
      return (((_a2 = a.values) == null ? void 0 : _a2.length) ?? 0) > 0 && !selectedValues[a.id];
    }
  ) : [];
  ...
  const activeStock = (selectedVariant == null ? void 0 : selectedVariant.stock) ?? product.stock;
  ...
  return /* @__PURE__ */ jsxs(StorefrontLayout, { auth, settings, children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "px-4 sm:px-8 lg:px-12 py-6 max-w-[1400px] mx-auto", children: [
      /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-10", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex gap-4", children: [
          imgs.length > 1 && /* @__PURE__ */ jsx("div", { className: "hidden lg:flex flex-col gap-2.5 w-[72px] flex-shrink-0", children: imgs.map((img, i) => /* @__PURE__ */ jsx(
            "button",
            {
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex-1 flex flex-col gap-3", children: [
            ...
            imgs.length > 1 && /* @__PURE__ */ jsx("div", { className: "flex lg:hidden gap-2 overflow-x-auto pb-1", children: imgs.map((img, i) => /* @__PURE__ */ jsx(
              "button",
              {
                onClick: () => setActiveImg(i),
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-5", children: [
          ...
          hasVariants && ((_g = product.variant_attributes) == null ? void 0 : _g.map((attr) => {
            ...
            return /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 mb-2.5", id: `attr-${attr.id}`, children: [
                ...
                (((_a2 = attr.values) == null ? void 0 : _a2.length) ?? 0) > 0 && /* @__PURE__ */ jsx("span", { className: "text-red-500 text-[13px]", children: "*" }),
          ...
          activeStock > 0 && /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center border-2 border-gray-200 rounded-xl overflow-hidden", children: [
              ...
              /* @__PURE__ */ jsx("span", { className: "w-12 text-center text-[15px] font-black", style: { color: "var(--color-dark-bg)" }, children: qty }),
              /* @__PURE__ */ jsx(
                "button",
                {
      ...
      /* @__PURE__ */ jsxs("div", { className: "mt-6 bg-white rounded-2xl border border-gray-100 p-6 lg:p-8", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between mb-6", children: [
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("h2", { className: "font-black text-[20px]", style: { fontFamily: "Manrope,sans-serif", color: "var(--color-dark-bg)" }, children: "Customer Reviews" }),
        ...
        reviews.length === 0 ? /* @__PURE__ */ jsxs("div", { className: "py-12 text-center", children: [
          ...
          return /* @__PURE__ */ jsxs("div", { className: "py-5", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-3 mb-2", children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "flex-1", children: [
                /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between flex-wrap gap-2", children: [
                  /* @__PURE__ */ jsx("span", { className: "font-bold text-[13.5px] text-gray-900", children: r.name }),
            ...
            r.title && /* @__PURE__ */ jsx("p", { className: "font-bold text-[13.5px] text-gray-900 mb-1 ml-13", children: r.title }),
      ...
      related.length > 0 && /* @__PURE__ */ jsxs("div", { className: "mt-8", children: [
        /* @__PURE__ */ jsx("h2", { className: "font-black text-[20px] mb-5", style: { fontFamily: "Manrope,sans-serif", color: "var(--color-dark-bg)" }, children: "You May Also Like" }),
