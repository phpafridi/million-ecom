...
function Wishlist({ items, settings, auth }) {
  ...
  function addToCart(product) {
    var _a;
    if (((_a = product.variant_attributes) == null ? void 0 : _a.length) > 0) {
      router3.visit(`/products/${product.slug}`);
      return;
    }
    router3.post("/cart/add", { product_id: product.id, quantity: 1 }, { preserveScroll: true });
  }
      ...
      items.length === 0 ? /* @__PURE__ */ jsxs("div", { className: "bg-white rounded-2xl border border-gray-100 p-16 text-center", children: [
        ...
        return /* @__PURE__ */ jsxs("div", { className: "bg-white rounded-2xl border border-gray-100 overflow-hidden hover:shadow-md transition-shadow", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "p-4", children: [
            ...
            /* @__PURE__ */ jsx(Link_default, { href: `/products/${product.slug}`, className: "font-semibold text-[14px] no-underline hover:text-[var(--color-primary)] line-clamp-2 block mb-2", style: { color: "var(--color-body-text)" }, children: product.name }),
              ...
              /* @__PURE__ */ jsxs(
                "button",
                {
                  ...
                  children: [
                    ...
                    " ",
                    ((_d = product.variant_attributes) == null ? void 0 : _d.length) > 0 ? "Select Options" : "Add to Cart"
                  ]
                }
              ),
              /* @__PURE__ */ jsx(
