...
function Login({ settings }) {
  ...
  const siteName = (settings == null ? void 0 : settings.site_name) ?? "Tijar Store";
  const tagline = (settings == null ? void 0 : settings.site_tagline) ?? "Admin Panel";
  const initial = ((_a = siteName[0]) == null ? void 0 : _a.toUpperCase()) ?? "T";
  function submit(e) {
    e.preventDefault();
    post("/login");
  }
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen flex items-center justify-center p-4", style: { background: "var(--color-body-bg, #f0f2f5)" }, children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "w-full max-w-md", children: [
      /* @__PURE__ */ jsxs("div", { className: "text-center mb-8", children: [
        /* @__PURE__ */ jsxs("div", { className: "inline-flex items-center gap-3 mb-2", children: [
          /* @__PURE__ */ jsx(
            "div",
            {
          ...
          /* @__PURE__ */ jsxs("div", { className: "text-left", children: [
            /* @__PURE__ */ jsx("div", { className: "font-manrope font-black text-2xl tracking-wider leading-none", style: { color: "var(--color-dark-bg, #0a0e1a)" }, children: siteName.toUpperCase() }),
            /* @__PURE__ */ jsx("div", { className: "text-[10px] font-bold tracking-[.16em] uppercase mt-0.5", style: { color: "var(--color-primary, #00c8ff)" }, children: tagline })
          ] })
        ] }),
        /* @__PURE__ */ jsx("p", { className: "text-gray-500 text-sm mt-3", children: "Sign in to your admin account" })
      ] }),
