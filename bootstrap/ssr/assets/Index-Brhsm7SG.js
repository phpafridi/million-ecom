...
import { IconPlus, IconChevronDown, IconChevronRight, IconPencil, IconTrash, IconX, IconUpload } from "@tabler/icons-react";
...
function ImageUpload({ label, w, h, hint, current, onFile }) {
  ...
  return /* @__PURE__ */ jsxs("div", { children: [
    ...
    preview && /* @__PURE__ */ jsxs("div", { className: "relative mb-2", children: [
      /* @__PURE__ */ jsx("img", { src: preview, className: "h-16 rounded-xl object-cover border border-gray-200 w-full", alt: "" }),
      /* @__PURE__ */ jsx(
        "button",
        {
          type: "button",
          onClick: () => setPreview(null),
          className: "absolute top-1 right-1 w-6 h-6 bg-red-500 text-white rounded-full flex items-center justify-center border-none cursor-pointer text-[10px]",
          children: "✕"
        }
      )
    ] }),
    /* @__PURE__ */ jsxs(
      "label",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx(IconUpload, { size: 15, style: { color: "var(--color-primary)" } }),
          /* @__PURE__ */ jsx("span", { className: "text-[12px] text-gray-500", children: preview ? "Replace image" : "Click or drag image here" })
        ]
      }
    )
  ] });
      ...
      /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-4", children: [
        /* @__PURE__ */ jsx(
          ImageUpload,
          {
            ...
            w: 300,
            h: 300,
            hint: "Square icon shown in category grid",
            current: cat == null ? void 0 : cat.image,
            onFile: (f) => setData("image", f)
          }
        ),
        /* @__PURE__ */ jsx(
          ImageUpload,
          {
            ...
            w: 1400,
            h: 280,
            hint: "Wide banner shown between product sections on homepage",
            current: cat == null ? void 0 : cat.banner_image,
            onFile: (f) => setData("banner_image", f)
          }
        )
      ] }),
