...
function FloatingCart({ settings }) {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx("style", { children: `
            ...
            ` }),
    /* @__PURE__ */ jsxs("button", { className: "ml-cart-fab", style: { background: bg }, onClick: () => setOpen((v) => !v), "aria-label": "Cart", children: [
    ...
    open && /* @__PURE__ */ jsx("div", { className: "ml-cart-panel", ref: panelRef, style: { background: "#161616" }, children: /* @__PURE__ */ jsxs("div", { style: { padding: "18px 18px 14px" }, children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "ml-header-row px-3 sm:px-6 lg:px-10 h-[58px] sm:h-[72px] flex items-center gap-2 sm:gap-3 overflow-hidden", children: [
            ...
            /* @__PURE__ */ jsxs(Link_default, { href: "/", className: "ml-header-logo flex items-center gap-1.5 sm:gap-2 flex-shrink-0 no-underline min-w-0", children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "min-w-0", children: [
                /* @__PURE__ */ jsx("div", { className: "font-manrope font-black text-[15px] sm:text-[19px] tracking-[1px] sm:tracking-[2px] leading-none truncate", style: { color: "var(--color-header-text, var(--color-dark-bg))" }, children: siteName }),
                tagline && /* @__PURE__ */ jsx("div", { className: "text-[8px] sm:text-[8px] tracking-[.15em] font-bold uppercase mt-0.5 truncate", style: { color: "var(--color-primary)" }, children: tagline })
              ] })
            ] }),
            /* @__PURE__ */ jsxs(
              "form",
