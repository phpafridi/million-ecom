...
import { u as usePage, r as router3, H as Head_default } from "../ssr.js";
...
function ChatAdmin({ sessions, faqs, stats }) {
  ...
  useEchoPublic("admin-chat-waiting", ".waiting.changed", (e) => {
    if (typeof e.waiting === "number") setWaiting(e.waiting);
  });
  useEffect(() => {
    activeRef.current = active;
  }, [active]);
  useEchoPublic(active ? `chat.${active.id}` : "chat.__none__", ".message.sent", (e) => {
  ...
  return /* @__PURE__ */ jsxs(AdminLayout, { title: "Live Chat", children: [
    ...
    tab === "chats" ? /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-3 gap-4", style: { height: "calc(100vh - 300px)" }, children: [
      /* @__PURE__ */ jsxs("div", { className: "bg-white rounded-2xl border border-gray-100 overflow-y-auto", children: [
        ...
        sessions.map((s) => /* @__PURE__ */ jsxs("div", { onClick: () => s.status === "waiting" ? join(s) : viewSession(s), className: `p-4 border-b border-gray-50 cursor-pointer hover:bg-gray-50 transition-colors ${(active == null ? void 0 : active.id) === s.id ? "bg-blue-50" : ""}`, children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "divide-y divide-gray-50", children: [
        faqs.map((f) => /* @__PURE__ */ jsxs("div", { className: "p-5 hover:bg-gray-50 flex items-start justify-between gap-4", children: [
          ...
          /* @__PURE__ */ jsx("button", { onClick: () => setPendingDeleteFaq(f.id), className: "w-8 h-8 rounded-lg border border-red-100 flex items-center justify-center text-red-400 hover:bg-red-50 cursor-pointer bg-white flex-shrink-0", children: /* @__PURE__ */ jsx(IconTrash, { size: 14 }) })
        ] }, f.id)),
    ...
    /* @__PURE__ */ jsx(
      ConfirmDeleteModal,
      {
        ...
        onConfirm: () => {
          if (pendingDeleteFaq) router3.delete(`${ap}/chat/faqs/${pendingDeleteFaq}`, { preserveScroll: true, onFinish: () => setPendingDeleteFaq(null) });
        },
