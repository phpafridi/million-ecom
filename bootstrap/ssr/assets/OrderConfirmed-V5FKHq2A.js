  ...
  return /* @__PURE__ */ jsxs(StorefrontLayout, { auth, settings, children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "max-w-xl mx-auto px-4 py-12 sm:py-20", children: [
      /* @__PURE__ */ jsxs("div", { className: "text-center mb-8", children: [
        ...
        /* @__PURE__ */ jsx("h1", { className: "font-manrope font-black text-[28px] sm:text-[32px] mb-2", style: { color: "var(--color-body-text)" }, children: "Order Placed!" }),
      ...
      order && /* @__PURE__ */ jsxs("div", { className: "bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden mb-5", children: [
        order.items && order.items.length > 0 && /* @__PURE__ */ jsx("div", { className: "p-5 border-b border-gray-100 space-y-3", children: order.items.map((item, i) => /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-start gap-3", children: [
          /* @__PURE__ */ jsxs("div", { className: "min-w-0", children: [
            /* @__PURE__ */ jsx("p", { className: "text-[13.5px] font-semibold truncate", style: { color: "var(--color-body-text)" }, children: item.product_name }),
            item.variant_label && /* @__PURE__ */ jsx("p", { className: "text-[12px] text-gray-500 mt-0.5", children: item.variant_label }),
          ...
          /* @__PURE__ */ jsx("span", { className: "text-[13.5px] font-bold whitespace-nowrap", style: { color: "var(--color-body-text)" }, children: fmt(item.subtotal) })
        ] }, i)) }),
        /* @__PURE__ */ jsxs("div", { className: "p-5 border-b border-gray-100", children: [
          ...
          typeof order.subtotal === "number" && /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-center mb-3", children: [
            /* @__PURE__ */ jsx("span", { className: "text-[13px] font-semibold text-gray-600", children: "Subtotal" }),
            /* @__PURE__ */ jsx("span", { className: "text-[13.5px]", style: { color: "var(--color-body-text)" }, children: fmt(order.subtotal) })
          ] }),
          !!order.discount && order.discount > 0 && /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-center mb-3", children: [
            /* @__PURE__ */ jsxs("span", { className: "text-[13px] font-semibold text-green-600", children: [
              "Discount",
              order.coupon_code ? ` (${order.coupon_code})` : ""
            ] }),
            /* @__PURE__ */ jsxs("span", { className: "text-[13.5px] font-semibold text-green-600", children: [
              "-",
              fmt(order.discount)
            ] })
          ] }),
          typeof order.shipping === "number" && /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-center mb-3", children: [
            /* @__PURE__ */ jsx("span", { className: "text-[13px] font-semibold text-gray-600", children: "Shipping" }),
            /* @__PURE__ */ jsx("span", { className: "text-[13.5px]", style: { color: "var(--color-body-text)" }, children: order.shipping > 0 ? fmt(order.shipping) : "Free" })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-center mb-3", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-center", children: [
            ...
            /* @__PURE__ */ jsx("span", { className: "font-semibold text-[13.5px]", style: { color: "var(--color-body-text)" }, children: method })
          ] })
        ] }),
        ...
        /* @__PURE__ */ jsxs("div", { className: "p-5 border-t border-gray-100", children: [
          ...
          /* @__PURE__ */ jsx("div", { className: "space-y-2.5", children: [
            ...
            /* @__PURE__ */ jsx("span", { className: `text-[12.5px] ${s.done ? "font-semibold" : "text-gray-500"}`, style: s.done ? { color: "var(--color-body-text)" } : {}, children: s.text })
          ] }, s.n)) })
        ] })
      ] }),
