...
import { IconPlus, IconChevronDown, IconChevronRight, IconChevronUp, IconPencil, IconTrash, IconX } from "@tabler/icons-react";
      ...
      /* @__PURE__ */ jsx("td", { className: "px-5 py-3", children: /* @__PURE__ */ jsxs("div", { className: "flex gap-1.5 ", children: [
        /* @__PURE__ */ jsx(
          "button",
          {
            ...
            title: "Move up",
            children: /* @__PURE__ */ jsx(IconChevronUp, { size: 14 })
          }
        ),
        /* @__PURE__ */ jsx(
          "button",
    ...
    open && hasChildren && cat.children.map((child, i) => {
      ...
      return /* @__PURE__ */ jsx(
        CatRow,
        {
          ...
          onDelete,
          canMoveUp: i > 0,
          canMoveDown: i < (((_a2 = cat.children) == null ? void 0 : _a2.length) ?? 0) - 1,
          onMoveUp: () => moveCategory(cat.children, i, -1),
          onMoveDown: () => moveCategory(cat.children, i, 1),
          moveCategory
        },
        child.id
      );
...
function CategoriesIndex({ categories, allCategories }) {
  ...
  function confirmDelete() {
    ...
    router3.delete(`${ap}/categories/${pendingDelete.id}`, { preserveScroll: true, onFinish: () => setPendingDelete(null) });
  }
  function moveCategory(siblings, index, direction) {
    const targetIndex = index + direction;
    if (targetIndex < 0 || targetIndex >= siblings.length) return;
    const a = siblings[index], b = siblings[targetIndex];
    router3.post(`${ap}/categories/reorder`, {
      items: [
  ...
  return /* @__PURE__ */ jsxs(AdminLayout, { title: "Categories & Menu", children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "bg-white rounded-2xl border border-gray-100 overflow-hidden", children: /* @__PURE__ */ jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxs("table", { className: "w-full min-w-[700px]", children: [
      ...
      /* @__PURE__ */ jsx("tbody", { children: categories.length === 0 ? /* @__PURE__ */ jsx("tr", { children: /* @__PURE__ */ jsx("td", { colSpan: 6, className: "px-5 py-16 text-center text-gray-400 text-[13px]", children: 'No categories yet. Click "Add Category" to create your first.' }) }) : categories.map((cat, i) => /* @__PURE__ */ jsx(
        CatRow,
        {
          cat,
          depth: 0,
          ...
          onMoveUp: () => moveCategory(categories, i, -1),
          onMoveDown: () => moveCategory(categories, i, 1),
          moveCategory
        },
        cat.id
      )) })
    ...
    /* @__PURE__ */ jsx(
      ...
      {
        open: !!pendingDelete,
        title: (((_a = pendingDelete == null ? void 0 : pendingDelete.children) == null ? void 0 : _a.length) ?? 0) > 0 ? "Delete this category? Sub-items will move to top level." : "Delete this category?",
