...
import { IconLayoutDashboard, IconPackage, IconShoppingBag, IconSearch, IconUsers, IconCategory, IconTag, IconStar, IconMail, IconHeadset, IconPhoto, IconTrendingUp, IconFileText, IconChartBar, IconCreditCard, IconChevronLeft, IconMessageCircle, IconUserCheck, IconPalette, IconWorld, IconBell, IconLock, IconPointFilled, IconSettings, IconMenu, IconX, IconExternalLink, IconUser, IconLogout, IconChevronDown } from "@tabler/icons-react";
const NAV = [
  {
    group: "STORE",
    defaultOpen: true,
...
function AdminLayout({ children, title }) {
  ...
  function dismissNotifs() {
    const total = (notifs == null ? void 0 : notifs.total) ?? 0;
  ...
  const userPerms = (_f = (_e = props.auth) == null ? void 0 : _e.user) == null ? void 0 : _f.permissions;
  const isRestrictedStaff = ((_h = (_g = props.auth) == null ? void 0 : _g.user) == null ? void 0 : _h.role) === "staff" && Array.isArray(userPerms);
  const visibleNav = isRestrictedStaff ? NAV.map((g) => ({
    ...g,
    items: g.items.filter((i) => !i.adminOnly && (i.perm === null || userPerms.includes(i.perm) || i.impliedBy && userPerms.includes(i.impliedBy)))
  })).filter((g) => g.items.length > 0) : NAV;
  const Sidebar = () => {
    var _a2;
    return /* @__PURE__ */ jsxs("div", { className: "flex flex-col h-full", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2.5 px-4 h-16 border-b border-white/8 flex-shrink-0", children: [
        ((_a2 = props.settings) == null ? void 0 : _a2.logo_url) ? /* @__PURE__ */ jsxs("div", { className: "h-9 flex-1 min-w-0 flex items-center gap-2 overflow-hidden", children: [
          /* @__PURE__ */ jsx("img", { src: props.settings.logo_url, alt: siteName, className: "h-full w-auto object-contain flex-shrink-0", style: { maxHeight: 36, maxWidth: 60 } }),
          /* @__PURE__ */ jsxs("div", { className: "min-w-0 flex-1", children: [
            /* @__PURE__ */ jsx("div", { className: "font-manrope font-black text-white text-[12.5px] leading-none truncate", children: siteName }),
            /* @__PURE__ */ jsx("div", { className: "text-[8.5px] text-white/35 font-semibold uppercase tracking-widest mt-0.5 truncate", children: "Admin Panel" })
          ] })
      ...
      /* @__PURE__ */ jsx("nav", { className: "flex-1 overflow-y-auto py-3 px-2 space-y-2", children: visibleNav.map((g) => /* @__PURE__ */ jsx(
        NavGroup,
        {
          ...g,
          ap,
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex-1 flex flex-col min-w-0 overflow-hidden", children: [
      /* @__PURE__ */ jsxs("header", { className: "bg-white border-b border-gray-100 h-14 flex items-center px-4 sm:px-6 gap-3 flex-shrink-0 shadow-sm", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "ml-auto flex items-center gap-2", children: [
          ((_i = props.flash) == null ? void 0 : _i.success) && /* @__PURE__ */ jsxs("span", { className: "hidden sm:flex items-center gap-1.5 text-[12px] font-semibold text-green-700 bg-green-50 border border-green-200 px-3 py-1.5 rounded-full", children: [
            "✓ ",
            props.flash.success
          ] }),
            ...
            /* @__PURE__ */ jsxs(
              "button",
              {
                ...
                children: [
                  ...
                  notifs.total > (dismissedAt ?? -1) && /* @__PURE__ */ jsx(
                    "span",
                    {
              ...
              children: [
                /* @__PURE__ */ jsx(
                  "div",
                  {
                    ...
                    children: (_j = userName[0]) == null ? void 0 : _j.toUpperCase()
                  }
                ),
      ...
      /* @__PURE__ */ jsxs("main", { className: "flex-1 overflow-y-auto p-4 sm:p-6", children: [
        ((_k = props.flash) == null ? void 0 : _k.error) && /* @__PURE__ */ jsxs("div", { className: "mb-4 p-3 bg-red-50 border border-red-200 rounded-xl text-[13px] text-red-700", children: [
          "⚠ ",
          props.flash.error
        ] }),
        children
