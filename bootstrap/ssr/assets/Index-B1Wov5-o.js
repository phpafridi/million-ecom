...
function PagesIndex({ pages, settings, togglePages = {} }) {
  const { props } = usePage();
    ...
    /* @__PURE__ */ jsxs("div", { className: "p-4 sm:p-6 max-w-5xl mx-auto", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex gap-5 flex-col lg:flex-row", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "flex-1 min-w-0", children: /* @__PURE__ */ jsx("form", { onSubmit: save, children: /* @__PURE__ */ jsxs("div", { className: "bg-white rounded-2xl border border-gray-100 overflow-hidden", children: [
          ...
          toggleKey && /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between px-5 py-4 border-b border-gray-100 bg-gray-50", children: [
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("p", { className: "font-black text-[13px] text-gray-900", children: "Show this page on the site" }),
              /* @__PURE__ */ jsx("p", { className: "text-[11.5px] text-gray-500 mt-0.5", children: data.visible === "0" ? "Hidden — visiting this page returns a 404, and it will disappear from the footer. Content stays saved." : "Visible — this page is live and linked from the footer." })
            ] }),
            /* @__PURE__ */ jsx(
              "button",
              {
