  ...
  return /* @__PURE__ */ jsxs(AdminLayout, { title: "IP Firewall", children: [
      ...
      /* @__PURE__ */ jsxs("table", { className: "w-full text-[13px]", children: [
        ...
        /* @__PURE__ */ jsx("tbody", { className: "divide-y divide-gray-50", children: (_a = ips.data) == null ? void 0 : _a.map((b) => /* @__PURE__ */ jsxs("tr", { className: "hover:bg-gray-50", children: [
          ...
          /* @__PURE__ */ jsx("td", { className: "px-4 py-3", children: /* @__PURE__ */ jsx("div", { className: "flex gap-2", children: b.is_active ? /* @__PURE__ */ jsxs(
            "button",
            {
              onClick: () => confirm("Unblock this IP? It will be able to access the site again immediately.") && router3.patch(`${window.location.pathname}/${b.ip}/unblock`, {}, { preserveScroll: true }),
            ...
            "button",
            {
              onClick: () => setPendingRemove({ id: b.id, ip: b.ip }),
    ...
    /* @__PURE__ */ jsx(
      ConfirmDeleteModal,
      {
        ...
        itemName: pendingRemove == null ? void 0 : pendingRemove.ip,
        onConfirm: () => {
          if (pendingRemove) router3.delete(`${window.location.pathname}/${pendingRemove.id}`, { preserveScroll: true, onFinish: () => setPendingRemove(null) });
        },
