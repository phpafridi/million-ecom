...
function StaffIndex({ staff, roles }) {
  ...
  const [form, setForm] = useState({ name: "", email: "", password: "", staff_role: "support", permissions: ((_a = roles["support"]) == null ? void 0 : _a.permissions) ?? [] });
  const [eform, setEform] = useState({ name: "", staff_role: "support", is_active: true, password: "", permissions: [] });
  ...
  function add(e) {
    ...
    router3.post(`${ap}/staff`, form, { onSuccess: () => {
      var _a2;
      setForm({ name: "", email: "", password: "", staff_role: "support", permissions: ((_a2 = roles["support"]) == null ? void 0 : _a2.permissions) ?? [] });
      setAdding(false);
    } });
  }
  function edit(e) {
  ...
  function confirmDelete() {
    ...
    router3.delete(`${ap}/staff/${pendingDelete.id}`, { onFinish: () => setPendingDelete(null) });
  }
  function startEdit(s) {
    setEditing(s);
    setEform({ name: s.name, staff_role: s.staff_role || "support", is_active: s.is_active, password: "", permissions: s.permissions ?? [] });
  }
  return /* @__PURE__ */ jsxs(AdminLayout, { title: "Staff & Roles", children: [
      ...
      /* @__PURE__ */ jsx("tbody", { className: "divide-y divide-gray-50", children: staff.map((s) => {
        ...
        return /* @__PURE__ */ jsxs("tr", { className: "hover:bg-gray-50", children: [
          /* @__PURE__ */ jsx("td", { className: "px-5 py-4", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
            /* @__PURE__ */ jsx("div", { className: "w-9 h-9 rounded-full flex items-center justify-center font-black text-white text-[13px]", style: { background: s.role === "admin" ? "var(--color-primary)" : ((_a2 = roles[s.staff_role]) == null ? void 0 : _a2.color) || "#6B7280" }, children: (_b = s.name[0]) == null ? void 0 : _b.toUpperCase() }),
    ...
    adding && /* @__PURE__ */ jsx("div", { className: "fixed inset-0 z-50 flex items-center justify-center p-4", style: { background: "rgba(0,0,0,0.5)" }, children: /* @__PURE__ */ jsxs("div", { className: "bg-white rounded-2xl shadow-2xl w-full max-w-md p-6", children: [
      ...
      /* @__PURE__ */ jsxs("form", { onSubmit: add, className: "space-y-4", children: [
        ...
        /* @__PURE__ */ jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsx("select", { className: inp, value: form.staff_role, onChange: (e) => {
            const role = e.target.value;
            setForm((f) => {
              var _a2;
              return { ...f, staff_role: role, permissions: ((_a2 = roles[role]) == null ? void 0 : _a2.permissions) ?? [] };
            });
          }, children: Object.entries(roles).map(([k, r]) => /* @__PURE__ */ jsxs("option", { value: k, children: [
            r.label,
            " — ",
            r.description
          ] }, k)) })
        ...
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("label", { className: "block text-[11px] font-bold text-gray-500 uppercase tracking-wide mb-1.5", children: "Page Access" }),
          /* @__PURE__ */ jsx("p", { className: "text-[11px] text-gray-400 mb-2", children: "Role sets sensible defaults above — adjust individual pages here if needed." }),
          /* @__PURE__ */ jsx("div", { className: "grid grid-cols-2 gap-1.5 p-3 bg-gray-50 rounded-xl max-h-[180px] overflow-y-auto", children: PERMISSION_OPTIONS.map((p) => /* @__PURE__ */ jsxs("label", { className: "flex items-center gap-2 cursor-pointer", children: [
            /* @__PURE__ */ jsx(
              "input",
              {
                type: "checkbox",
            ...
            /* @__PURE__ */ jsx("span", { className: "text-[12px] text-gray-700", children: p.label })
          ] }, p.key)) }),
          /* @__PURE__ */ jsxs("label", { className: "flex items-center gap-2 cursor-pointer mt-2 p-2.5 bg-red-50 border border-red-100 rounded-xl", children: [
            /* @__PURE__ */ jsx(
              "input",
              {
                type: "checkbox",
                className: "w-3.5 h-3.5 accent-red-600",
                checked: form.permissions.includes("can_delete"),
                onChange: (e) => setForm((f) => ({ ...f, permissions: e.target.checked ? [...f.permissions, "can_delete"] : f.permissions.filter((x) => x !== "can_delete") }))
              }
            ),
            /* @__PURE__ */ jsx("span", { className: "text-[12px] font-semibold text-red-700", children: "Allow deleting items (applies across every page above)" })
          ] })
        ] }),
    ...
    editing && /* @__PURE__ */ jsx("div", { className: "fixed inset-0 z-50 flex items-center justify-center p-4", style: { background: "rgba(0,0,0,0.5)" }, children: /* @__PURE__ */ jsxs("div", { className: "bg-white rounded-2xl shadow-2xl w-full max-w-md p-6", children: [
      ...
      /* @__PURE__ */ jsxs("form", { onSubmit: edit, className: "space-y-4", children: [
        ...
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("label", { className: "block text-[11px] font-bold text-gray-500 uppercase tracking-wide mb-1.5", children: "Role" }),
          /* @__PURE__ */ jsx("select", { className: inp, value: eform.staff_role, onChange: (e) => {
            const role = e.target.value;
            setEform((f) => {
              var _a2;
              return { ...f, staff_role: role, permissions: ((_a2 = roles[role]) == null ? void 0 : _a2.permissions) ?? [] };
            });
          }, children: Object.entries(roles).map(([k, r]) => /* @__PURE__ */ jsx("option", { value: k, children: r.label }, k)) })
        ] }),
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("label", { className: "block text-[11px] font-bold text-gray-500 uppercase tracking-wide mb-1.5", children: "Page Access" }),
          /* @__PURE__ */ jsx("div", { className: "grid grid-cols-2 gap-1.5 p-3 bg-gray-50 rounded-xl max-h-[180px] overflow-y-auto", children: PERMISSION_OPTIONS.map((p) => /* @__PURE__ */ jsxs("label", { className: "flex items-center gap-2 cursor-pointer", children: [
            /* @__PURE__ */ jsx(
              "input",
              {
                type: "checkbox",
                className: "w-3.5 h-3.5",
                checked: eform.permissions.includes(p.key),
          ...
          /* @__PURE__ */ jsxs("label", { className: "flex items-center gap-2 cursor-pointer mt-2 p-2.5 bg-red-50 border border-red-100 rounded-xl", children: [
            /* @__PURE__ */ jsx(
              "input",
              {
                type: "checkbox",
                className: "w-3.5 h-3.5 accent-red-600",
                checked: eform.permissions.includes("can_delete"),
    ...
    /* @__PURE__ */ jsx(
      ConfirmDeleteModal,
      {
        ...
        itemName: pendingDelete == null ? void 0 : pendingDelete.name,
        requireTypedConfirmation: pendingDelete == null ? void 0 : pendingDelete.name,
