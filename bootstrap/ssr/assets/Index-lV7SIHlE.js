...
import { IconExternalLink, IconRobot, IconInfoCircle, IconWorld, IconUpload } from "@tabler/icons-react";
...
function SeoIndex({ seo }) {
  ...
  const authRole = ((_b = (_a = _p.auth) == null ? void 0 : _a.user) == null ? void 0 : _b.role) ?? "";
  ...
  return /* @__PURE__ */ jsxs(AdminLayout, { title: "SEO Settings", children: [
    ...
    /* @__PURE__ */ jsxs("form", { onSubmit: submit, className: "grid grid-cols-1 lg:grid-cols-3 gap-5 max-w-5xl", children: [
      /* @__PURE__ */ jsxs("div", { className: "lg:col-span-2 space-y-5", children: [
        ...
        /* @__PURE__ */ jsx(Section, { title: "Search Console Verification", icon: "✅", children: /* @__PURE__ */ jsx(Field, { label: "Google Search Console Verification Code", hint: "From Search Console → Settings → Ownership verification → HTML tag method. Paste just the content value, not the full tag.", children: /* @__PURE__ */ jsx(
          Input,
          {
        ...
        /* @__PURE__ */ jsxs(Section, { title: "Product Feed — Meta & Google Ads", icon: "🛍️", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-2 p-3 bg-blue-50 border border-blue-100 rounded-lg text-[12px] text-blue-800 leading-relaxed", children: [
            /* @__PURE__ */ jsx(IconInfoCircle, { size: 14, className: "flex-shrink-0 mt-0.5" }),
            /* @__PURE__ */ jsxs("span", { children: [
              "Paste this URL into ",
              /* @__PURE__ */ jsx("strong", { children: "Meta Commerce Manager → Catalog → Add Items → Data Feed" }),
              " (or Google Merchant Center), set it to refresh daily, and your product prices, stock, and new items sync to your ads automatically — no manual re-uploads."
            ] })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsx(
              ...
              {
                readOnly: true,
                value: `${data.site_url || window.location.origin}/feed/facebook-products.xml`,
          ...
          /* @__PURE__ */ jsxs(
            "a",
            {
              href: "/feed/facebook-products.xml",
              target: "_blank",
              rel: "noopener noreferrer",
              className: "flex items-center justify-between p-3.5 border border-gray-200 rounded-xl hover:border-[var(--color-primary,#00c8ff)] transition-all no-underline group",
              children: [
                /* @__PURE__ */ jsxs("div", { children: [
                  /* @__PURE__ */ jsx("div", { className: "text-[13px] font-semibold text-gray-800", children: "Preview Feed" }),
                  /* @__PURE__ */ jsx("div", { className: "text-[11.5px] text-gray-400", children: "Opens the live XML — only in-stock, active products are included" })
                ] }),
                /* @__PURE__ */ jsx(IconExternalLink, { size: 16, className: "text-gray-400 group-hover:text-[var(--color-primary,#00c8ff)]" })
              ]
            }
        ...
        /* @__PURE__ */ jsxs("a", { href: `${ap}/analytics`, className: "block bg-gradient-to-br from-gray-900 to-gray-800 rounded-2xl p-4 text-white no-underline hover:opacity-90 transition-opacity", children: [
          /* @__PURE__ */ jsx("div", { className: "text-[13px] font-bold flex items-center gap-2", children: "📊 Looking for Google Analytics, GTM, or Pixel IDs?" }),
          /* @__PURE__ */ jsx("div", { className: "text-[12px] text-gray-300 mt-1", children: "Those live on the dedicated Analytics page →" })
        ] }),
        /* @__PURE__ */ jsxs(Section, { title: "Advanced — Custom Head Scripts", icon: "⚙️", children: [
          /* @__PURE__ */ jsxs("div", { className: "mb-3 p-3 rounded-xl bg-amber-50 border border-amber-200 text-[12.5px] text-amber-800 leading-relaxed", children: [
            "⚠️ ",
            /* @__PURE__ */ jsx("strong", { children: "This runs on every single customer page load, unrestricted." }),
            " Only paste code from sources you fully trust — this is not sandboxed. For Google Analytics, Meta Pixel, GTM, or TikTok Pixel specifically, use the Analytics page instead (safer — they don't accept arbitrary script). Restricted to full Admin accounts only."
          ] }),
          /* @__PURE__ */ jsx(Field, { label: "Custom HTML / Analytics Scripts", hint: authRole === "admin" ? "Paste tracking scripts not covered by the dedicated fields above." : "Only full Admin accounts can edit this field.", children: /* @__PURE__ */ jsx(
            "textarea",
            {
