...
function Contact({ settings, content = {}, auth }) {
  ...
  return /* @__PURE__ */ jsxs(StorefrontLayout, { auth, settings, children: [
    ...
    /* @__PURE__ */ jsxs("div", { style: { background: "var(--color-dark-bg, #0a0a0a)", padding: "clamp(56px,9vw,100px) clamp(20px,6vw,64px)", position: "relative", overflow: "hidden" }, children: [
      ...
      /* @__PURE__ */ jsxs("div", { style: { maxWidth: 700, position: "relative" }, children: [
        /* @__PURE__ */ jsxs("div", { style: { display: "inline-flex", alignItems: "center", gap: 8, background: "rgba(201,168,76,0.12)", border: "1px solid rgba(201,168,76,0.25)", borderRadius: 100, padding: "5px 14px", marginBottom: 20 }, children: [
          ...
          /* @__PURE__ */ jsx("span", { style: { fontSize: 11, fontWeight: 800, color: "var(--color-primary)", letterSpacing: "0.15em", textTransform: "uppercase" }, children: c.contact_hero_eyebrow ?? "Get in Touch" })
        ] }),
        /* @__PURE__ */ jsxs("h1", { style: { fontFamily: "Manrope, sans-serif", fontWeight: 900, fontSize: "clamp(28px,5.5vw,52px)", color: "white", margin: "0 0 14px", lineHeight: 1.05 }, children: [
          c.contact_hero_title1 ?? "We're here to help",
          /* @__PURE__ */ jsx("br", {}),
          /* @__PURE__ */ jsx("span", { style: { color: "var(--color-primary)" }, children: c.contact_hero_title2 ?? "anytime." })
        ] }),
        /* @__PURE__ */ jsx("p", { style: { fontSize: 15, color: "rgba(255,255,255,0.5)", lineHeight: 1.7, margin: 0 }, children: c.contact_hero_subtitle ?? "Questions about your order, products, or anything else? Our team responds within 1 hour during business hours." })
      ] })
    ] }),
    /* @__PURE__ */ jsx("div", { style: { maxWidth: 1200, margin: "0 auto", padding: "clamp(40px,6vw,64px) clamp(20px,5vw,48px)" }, children: /* @__PURE__ */ jsxs("div", { style: { display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: 40 }, children: [
      /* @__PURE__ */ jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsx("div", { style: { display: "flex", flexDirection: "column", gap: 12, marginBottom: 32 }, children: contacts.map((cn) => /* @__PURE__ */ jsxs(
          "a",
          {
            href: cn.href,
            target: cn.href.startsWith("http") ? "_blank" : void 0,
            ...
            children: [
              /* @__PURE__ */ jsx("div", { style: { width: 44, height: 44, borderRadius: 12, display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0, background: cn.color + "15", color: cn.color }, children: cn.icon }),
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx("p", { style: { fontSize: 11, fontWeight: 700, color: "#9CA3AF", textTransform: "uppercase", letterSpacing: "0.08em", margin: "0 0 2px" }, children: cn.label }),
                /* @__PURE__ */ jsx("p", { style: { fontSize: 14, fontWeight: 700, color: "#111", margin: 0 }, children: cn.value })
              ] })
            ]
          },
          cn.label
        ...
        /* @__PURE__ */ jsxs("div", { style: { background: "var(--color-dark-bg, #0a0a0a)", borderRadius: 20, padding: "24px 22px" }, children: [
          ...
          hours.map(([d, t]) => /* @__PURE__ */ jsxs("div", { style: { display: "flex", justifyContent: "space-between", padding: "8px 0", borderBottom: "1px solid rgba(255,255,255,0.07)" }, children: [
      ...
      /* @__PURE__ */ jsxs("div", { children: [
        ...
        sent ? /* @__PURE__ */ jsxs("div", { style: { background: "#F0FDF4", border: "2px solid #86EFAC", borderRadius: 20, padding: "40px 32px", textAlign: "center" }, children: [
          ...
          /* @__PURE__ */ jsx("p", { style: { fontSize: 12, color: "#9CA3AF", textAlign: "center", margin: 0 }, children: c.contact_response_note ?? "We respond within 1 hour · Mon–Sat 10AM–8PM" })
        ] })
      ] })
    ] }) })
  ] });
