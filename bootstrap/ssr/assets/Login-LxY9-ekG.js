  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen flex items-center justify-center p-4", style: { background: "var(--color-body-bg, #f0f2f5)" }, children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "w-full max-w-md", children: [
      /* @__PURE__ */ jsxs("div", { className: "text-center mb-8", children: [
        /* @__PURE__ */ jsx("div", { className: "inline-flex items-center gap-3 mb-2", children: (settings == null ? void 0 : settings.logo_url) ? /* @__PURE__ */ jsx("img", { src: settings.logo_url, alt: siteName, className: "h-12 w-auto object-contain", style: { maxWidth: 220 } }) : /* @__PURE__ */ jsxs(Fragment, { children: [
          /* @__PURE__ */ jsx(
            "div",
            {
