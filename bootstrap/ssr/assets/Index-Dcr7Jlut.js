...
function SystemLogs({ logs, suspicious, stats, filters, settings, auth }) {
  ...
  return /* @__PURE__ */ jsxs(AdminLayout, { title: "System Logs", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "bg-white rounded-xl border border-gray-100 p-4 mb-4 flex flex-wrap gap-3 items-end", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "ml-auto", children: /* @__PURE__ */ jsxs("button", { onClick: () => {
        if (confirm("Clear logs older than 30 days?"))
          router3.delete(window.location.pathname + "/clear", { data: { days: 30 } });
      }, className: "flex items-center gap-1.5 px-3 py-2 rounded-lg bg-red-50 border border-red-200 text-red-600 text-[13px] hover:bg-red-100 cursor-pointer", children: [
