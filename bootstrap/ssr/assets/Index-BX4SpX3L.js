    ...
    /* @__PURE__ */ jsx("div", { className: "min-h-screen py-0 lg:py-8 px-0 lg:px-4", style: { background: "var(--color-body-bg)" }, children: /* @__PURE__ */ jsx("div", { className: "max-w-5xl mx-auto", children: /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-4 gap-5", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "lg:col-span-3 space-y-5 px-4 pt-5 lg:px-0 lg:pt-0", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "grid grid-cols-2 sm:grid-cols-4 gap-3", children: [
          ...
          /* @__PURE__ */ jsx("p", { className: "font-black text-[20px]", style: { color: "var(--color-body-text)" }, children: s.value }),
        ...
        /* @__PURE__ */ jsxs("div", { className: "bg-white rounded-2xl border border-gray-100 p-5", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between mb-4", children: [
            /* @__PURE__ */ jsx("h3", { className: "font-black text-[16px]", style: { color: "var(--color-body-text)" }, children: "Recent Orders" }),
            /* @__PURE__ */ jsxs(
              Link_default,
              {
                href: "/account/orders",
              ...
              children: [
                /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
                  ...
                  /* @__PURE__ */ jsxs("div", { children: [
                    /* @__PURE__ */ jsx("p", { className: "font-bold text-[13.5px]", style: { color: "var(--color-body-text)" }, children: order.order_number ?? `Order #${order.id}` }),
                ...
                /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
                  ...
                  /* @__PURE__ */ jsx("p", { className: "font-black text-[14px]", style: { color: "var(--color-body-text)" }, children: fmt(order.total) }),
          ...
          Link_default,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "min-w-0", children: [
                /* @__PURE__ */ jsx("p", { className: "font-bold text-[13px]", style: { color: "var(--color-body-text)" }, children: q.label }),
