...
interface Props  { pages: Record<string, Page>; settings: Record<string, string> }
...
export default function PagesIndex({ pages, settings }: Props) {
    ...
    // Build one big form with ALL keys from all pages
    ...
    const { data, setData, put, processing, recentlySuccessful } = useForm<Record<string, string>>(initialData)
