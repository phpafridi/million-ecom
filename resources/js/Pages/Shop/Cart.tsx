...
export default function Cart({ items, subtotal, shipping, total, discount=0, points_discount=0, coupon_discount=0, loyalty_points=0, loyalty_value=0, points_used=0, loyalty_enabled=true, redeem_enabled=true, user_profile, gateways, settings, auth }: Props) {
    ...
    function validateForm(): boolean {
        ...
        if (data.email && !/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(data.email)) { setError('email', 'Enter a valid email address'); valid = false }
        ...
        return (
            <StorefrontLayout auth={auth} settings={settings}>
                ...
                <div className="max-w-lg mx-auto px-4 py-20 text-center">
                    ...
                    <h2 className="font-manrope font-black text-[26px] text-gray-900 mb-3">Your cart is empty</h2>
                ...
                <div className="max-w-2xl mx-auto px-4 py-10">
                    <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
                        ...
                        <div className="p-6 space-y-5">
                            ...
                            {hasAny && (
                                <div>
                                    <h3 className="font-bold text-[15px] text-gray-900 mb-3 flex items-center gap-2">
                            ...
                            <form onSubmit={goToPayment} className="space-y-5" noValidate>
                                ...
                                <div className="bg-white rounded-2xl border border-gray-100 p-5">
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                        ...
                                        <div>
                                            <label className="block text-[12.5px] font-semibold text-gray-700 mb-1.5">Email <span className="text-gray-400 font-normal">(optional — for receipt)</span></label>
                                            <input value={data.email} onChange={e => setData('email', e.target.value)}
                                                placeholder="ali@email.com" type="email" className={inputCls(errors.email)}/>
                                                ...
                                                <label key={gw.code}
                                                    ...
                                                    <div className="flex-1">
                                                        <div className="flex items-center gap-2">
                                                            <span className="font-bold text-[14px] text-gray-900">{gw.name}</span>
